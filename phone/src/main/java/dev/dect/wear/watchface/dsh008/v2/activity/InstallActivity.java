...
import dev.dect.wear.watchface.dsh008.v2.downloader.VersionsDownloader;
import dev.dect.wear.watchface.dsh008.v2.model.Version;
import dev.dect.wear.watchface.dsh008.v2.popup.PickerPopup;
...
public class InstallActivity extends AppCompatActivity {
    ...
    private void initListeners() {
        ...
        findViewById(R.id.btnMore).setOnClickListener((v) -> {
            ...
            popupMenu.getMenuInflater().inflate(R.menu.more_install, menu);
    ...
    private void updateStepUI() {
        ...
        if(ANIMATIONS[CURRENT_STEP] == -1) {
            ...
            try {
                ...
                Log.e(TAG, "updateStepUI: " + e.getMessage());
            }
        }
    }
    ...
    private void fetchVersionsFromInternet() {
        new VersionsDownloader((data) -> new Handler(Looper.getMainLooper()).post(() -> {
            if(data == null) {
                ...
                Log.e(TAG, "fetchVersionsFromInternet0: null");
            ...
            try {
                ...
                if(VERSIONS.isEmpty()) {
                    ...
                    Log.e(TAG, "fetchVersionsFromInternet1: VERSIONS.isEmpty() => true");
                ...
                Log.e(TAG, "fetchVersionsFromInternet2: " + e.getMessage());
