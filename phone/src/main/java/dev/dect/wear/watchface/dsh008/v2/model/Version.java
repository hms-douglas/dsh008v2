...
public class Version implements Serializable {
    private final static String TAG = Version.class.getSimpleName() + "Model";
    ...
    public Version(JSONObject jsonObject) {
        try {
            this.VERSION_NAME = jsonObject.getString(Constants.Url.KeyTag.LATEST_VERSION_VERSION_NAME);
            this.LINK = jsonObject.getString(Constants.Url.KeyTag.LATEST_VERSION_LINK);
            this.VERSION_CODE = Integer.parseInt(jsonObject.getString(Constants.Url.KeyTag.LATEST_VERSION_VERSION_CODE));
            this.ERROR = false;
        } catch (Exception e) {
            this.ERROR = true;
